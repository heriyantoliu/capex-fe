  ...
  <div>
    <div class="m-content">
      <b-tabs>
                ...
                <div class="m-portlet__body">
                  <div class="m-form__section m-form__section--first">
                    <b-container fluid>
                      ...
                      <div
                        v-if="
                    capexInfo.nextApproval == username &&
        ...
        <b-tab title="Budget">
          <list-budget-code
            :listBudgetCode="listBudgetCode"
            :amount="capexInfo.totalAmount"
            disabled
          />
        </b-tab>
      </b-tabs>
...
export default {
    ...
    fetchCapex(ID) {
      new Promise(async (resolve) => {
        try {
          ...
          this.totalRemaining = this.listBudgetCode.reduce((a, b) => {
  ...
  async created() {
    try {
      ...
      this.budgetApprovalCodeData = result.data.budgetInfo.map((budget) => {
        return {
          ...budget,
